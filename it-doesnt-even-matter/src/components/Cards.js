...
console.log(dog.url);
    return (
        <Card style={{position:'relative' ,width: '80%', height:"100%" ,  border:'none', color:"white", borderRadius:"15%", marginBottom:"20px", marginLeft:'20px', visibility:'visible'}} onMouseOver={handleHover} onMouseLeave={handleLeave}>
           <Card.Img variant='top' className="card-img" src={dog.url} style={{ height:'33%', width:'100%', justifySelf:'stretch',borderRadius:"15%", marginBottom:"10px", opacity: isHovered? '50%' : '100%'}} alt="dog pic" />
